...
window.addEventListener('load', function(){
	...
	*/
	...
	document.getElementById('addList').addEventListener('click', function(){
		...
		document.getElementById('list'+length).insertAdjacentHTML('afterend', "<div id='list"+newLength+"'>List of terminals "+newLength+": <input type='text' name='genStringsInput'><p>Number of terminals in generated strings:</p><p class='genStringsNum'>Min: <select name='genStringsMin' id='genStringsMin' style=‘width:40px;’><option value=‘1’>1</option><option value=‘2’>2</option><option value=‘3’>3</option><option value=‘4’>4</option><option value=‘5’>5</option><option value=‘6’>6</option><option value=‘7’>7</option><option value=‘8’>8</option><option value=‘9’>9</option></select></p><p class='genStringsNum'>Max:<select name='genStringsMax' id='genStringsMax' style=‘width:40px;’><option value=‘1’>1</option><option value=‘2’>2</option><option value=‘3’>3</option><option value=‘4’>4</option><option value=‘5’>5</option><option value=‘6’>6</option><option value=‘7’>7</option><option value=‘8’>8</option><option value=‘9’>9</option></select></p></div>");
		document.getElementById('autoDoneMessage').style.display = 'none';
	});
